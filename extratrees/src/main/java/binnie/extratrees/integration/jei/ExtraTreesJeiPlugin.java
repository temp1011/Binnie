...
public class ExtraTreesJeiPlugin implements IModPlugin {
	...
	public void registerItemSubtypes(ISubtypeRegistry subtypeRegistry) {
		...
		if(ModuleHelper.isModuleEnabled(Constants.EXTRA_TREES_MOD_ID, ExtraTreesModuleUIDs.ALCOHOL)) {
	...
	public void registerCategories(IRecipeCategoryRegistration registry) {
		...
		if(ModuleHelper.isModuleEnabled(Constants.EXTRA_TREES_MOD_ID, ExtraTreesModuleUIDs.MACHINES)) {
